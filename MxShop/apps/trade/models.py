...
User = get_user_model()  # 由于用户模型是继承的django的 所以这种方法也可以找到继承用户模型 通过在settings中的配置找到的
...
class OrderInfo(models.Model):
    ...
    trade_no = models.CharField(max_length=100, unique=True, null=True, blank=True, verbose_name='第三方订单号')
...
class OrderGoods(models.Model):
    ...
    订单的商品详情
    '''
    order = models.ForeignKey(OrderInfo, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='订单信息')
    goods = models.ForeignKey(Goods, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='商品')
